...
namespace data
{
const std::vector<std::string_view, 4> ComputerTypes = {"Desktop", "Laptop", "Mainframe", "Supercomputer"};

const std::vector<std::string_view, 20> ComputerManufactures = {
...
const std::vector<std::string_view, 50> ComputerModels = {
...
const std::vector<std::string_view, 5> ComputerCPUManufactures = {"Intel", "AMD", "ARM", "IBM", "Apple"};

const std::vector<std::string_view, 12> ComputerCPUTypes = {
    "Dual-Core", "Quad-Core", "Hexa-Core", "Octa-Core", "Deca-Core", "Heterogeneous System Architecture",
    "ARM",       "x86",       "64-bit",    "32-bit",    "RISC",      "CISC"};

const std::vector<std::string_view, 26> ComputerCPUModels = {
...
const std::vector<std::string_view, 5> ComputerGPUManufactures = {
    "NVIDIA", "AMD", "Intel", "ARM", "Qualcomm",
};

const std::vector<std::string_view, 2> ComputerGPUTypes = {"Integrated", "Discrete"};

const std::vector<std::string_view, 23> ComputerGPUModels = {"NVIDIA GeForce RTX 3090",
